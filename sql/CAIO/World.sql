...
REPLACE INTO `command` (`name`, `permission`, `help`) VALUES ('caio addaddon', 5000, 'Syntax: .caio addaddon $addonName "$addonFile" [$permission]\nAdds an addon to the addon list (default permission if omitted) and force-reloads players that have that RBAC permission');
...
REPLACE INTO `command` (`name`, `permission`, `help`) VALUES ('caio forcereloadall', 5000, 'Syntax: .caio forcereloadall [$permission]\nForce reloads players that have the given RBAC permission (exact match). Affected players\' addons are synced with the server.');
REPLACE INTO `command` (`name`, `permission`, `help`) VALUES ('caio forceresetall', 5000, 'Syntax: .caio forceresetall [$permission]\nForce resets players that have the given RBAC permission (exact match). Affected players\' addons are deleted and downloaded again.');
...
REPLACE INTO `command` (`name`, `permission`, `help`) VALUES ('caio sendall', 5000, 'Syntax: .caio sendall "Message" [$permission]\nSends an addon message to all players that have the given RBAC permission (exact match)');
